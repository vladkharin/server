export const REQUESTS = {
  ...
  serverMemberRoleUpdate: 'server:member:role:update',
  serverMemberKick: 'server:member:kick',
  serverInviteRegenerate: 'server:invite:regenerate',
...
export const NOTIFICATIONS = {
  ...
  serverUpdated: 'notification.server.updated',
  serverMemberUpdated: 'notification.server.member.updated',
  serverMemberKicked: 'notification.server.member.kicked',
